...
struct run_test_t test_array[] = {
	...
	{ read_one_sector_after_write, "read one sector after physical write (correct CRC)", 16 }, // 46
	...
	{ read_one_meg_after_write, "read 1MB after physical write (correct CRC)", 16 }, // 49
	...
	{ corrupt_read_correct_one_meg_disk2, "read corrected one meg error from disk2", 18 }, // 72
	...
	{ recover_one_meg_disk2, "recover 1MB filled with errors from disk2", 18 }, // 77
